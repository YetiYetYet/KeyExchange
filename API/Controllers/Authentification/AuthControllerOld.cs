...
//         
//         // Get Basic Roles
//         ApplicationRole userRole = _dbApplicationDbContext.Roles.Single(x => x.Key == "ApplicationUser");
//         
//         // Create ApplicationUser and UserProfile
//         Models.ApplicationUser? user = AutoMapperUtils.BasicAutoMapper<RegisterDto, Models.ApplicationUser>(registerDto);
//         //user.ApplicationRole = userRole;
//         user.CreatedBy = 0;
...
//     {
//         Console.WriteLine(HttpContext.ApplicationUser.Identity?.Name);
//         return Ok(HttpContext.ApplicationUser.Identity?.Name);
//     }
//     
//     //  Just a test
...
//
//         Models.ApplicationUser user = _dbApplicationDbContext.Users.First(x => x.Username == loginDto.Username);
...
//     {
//         Models.ApplicationUser? user = await _dbApplicationDbContext.Users.Where(user => user.Email == request.Email).FirstOrDefaultAsync();
//         if (user == null)
//             return NotFound("ApplicationUser with this email don't exist.");
