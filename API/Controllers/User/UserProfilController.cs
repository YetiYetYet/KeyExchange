...
//
// namespace API.Controllers.ApplicationUser;
//
// [ApiController]
// [Route("[controller]")]
...
//         var userProfileDtos = AutoMapperUtils.TupleAutoMapper<Models.ApplicationUser, UserProfileDto>(user, new List<(Type SourceType, Type Destination)>() {(typeof(ApplicationRole), typeof(RoleDto))});
...
//         }
//         UserProfileDto userProfileDto = AutoMapperUtils.TupleAutoMapper<Models.ApplicationUser, UserProfileDto>(user, new List<(Type SourceType, Type Destination)>() {(typeof(ApplicationRole), typeof(RoleDto))});
